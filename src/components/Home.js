        ...
        return(
            <Content style={{marginTop: 64, bottom:"10%", background:"#FFF"}}>
                ...
                <Row type="flex" align="middle">
                    <MouseDownAnimation style={{zIndex:10}}/>
                    ...
                    <p className="subtitle">
                        ...
                        <Row type="flex" justify="center" >
                            ...
                            <Button type="primary" size="large" style={{width:"100%",minWidth:"150px",height:40}} className="btn-gradient">Saiba mais</Button>
                            </Col>
                             <Col md={{span:11,offset:1}} xs={{span:11,offset:1}}>
                             <Button size="large" style={{width:"100%", minWidth:"150px",height:40}}>Junte-se a nós</Button>
                            </Col>
                        </Row>
                    </Col>
